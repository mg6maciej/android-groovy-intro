/*
 * Copyright (C) 2015 Maciej Górski
 ...
 * {@link android.support.test.runner.AndroidSpockRunner} and the appropriate android:targetPackage
 * set.
 * <p/>
 * Execution options:
 * <p/>
 ...
 * the {@link android.test.suitebuilder.annotation.LargeTest} and "com.android.foo.MyAnnotation" annotations.
 * <p/>
 ...
 * the {@link android.test.suitebuilder.annotation.LargeTest} annotation that do NOT have the "com.android.foo.MyAnnotation" annotations.
 * <p/>
 ...
 * <p/>
 * <b> To specify one or more {@link org.junit.runner.notification.RunListener}s to observe the test run:</b>
...
public class AndroidSpockRunner extends MonitoringInstrumentation {
    ...
    /**
     * Add extra {@link org.junit.runner.notification.RunListener}s specified via command line
     */
    ...
    /**
     * Add extra {@link org.junit.runner.notification.RunListener}s to the testRunner as given in the csv class name list
     *
     * @param extraListenerList the CSV class name of {@link org.junit.runner.notification.RunListener}s to add
    ...
    /**
     * Builds a {@link android.support.test.internal.runner.TestRequest} based on given input arguments.
     * <p/>
     * Exposed for unit testing.
     */
    ...
    /**
     * Factory method for {@link android.support.test.internal.runner.SpockTestRequestBuilder}.
     * <p/>
     * Exposed for unit testing.
     */
     ...
     */
    void addTimeout(String timeout, SpockTestRequestBuilder testRequestBuilder) {
